            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="{{route('admin.digitalsearch.copy')}}">复制品统计</a></li>
                        <li ><a href="{{route('admin.digitalsearch.copy.copy_by')}}">仿制品统计</a></li>
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <form role="form" class="form-inline" method="get" action="{{route('admin.digitalsearch.copy')}}">
